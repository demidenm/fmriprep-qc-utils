...
from utils import (voxel_inout_ratio, boldref_to_targetspace,
target_extractbrain, process_subject_run_minimal)
    ...
    for sub in subj_list:
        ...
        for sess in session_list:
            ...
            for runnum in run_list:
                qc_result = process_subject_run_minimal(
                    sub=sub,
                    taskname=taskname,
                    sess=sess,
                    runnum=runnum,
                    fmrirepderiv_layout=fmrirepderiv_layout,
...
filename = f"study-{study_id}_check-bold_fmriprep-minimal.tsv"
